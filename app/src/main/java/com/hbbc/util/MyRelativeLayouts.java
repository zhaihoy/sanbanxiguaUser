 ...
 */
public class MyRelativeLayouts extends RelativeLayout {
...
//            capturedChild.invalidate();穿透更严重
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (yvel < -1500) {//向上滑动
                ...
                ViewCompat.postInvalidateOnAnimation(MyRelativeLayouts.this);
                return;
            }
...
//            invalidate();
    ...
    public MyRelativeLayouts(Context context) {
    ...
    public MyRelativeLayouts(Context context, AttributeSet attrs) {
    ...
    public MyRelativeLayouts(Context context, AttributeSet attrs, int defStyleAttr) {
