...
public class PullToRefreshView extends LinearLayout {
    ...
    /**
     * header refresh fxzc_time
     */
    private TextView mHeaderUpdateTextView;
    /**
     * footer refresh fxzc_time
     */
    ...
    private void addHeaderView() {
        // header view
        mHeaderView = mInflater.inflate(R.layout.util_refresh_header, this, false);
        ...
        mHeaderUpdateTextView = (TextView) mHeaderView.findViewById(R.id.pull_to_refresh_text);
        ...
        mHeaderViewHeight += mHeaderView.getPaddingBottom();
...
//		 mHeaderView.setLayoutParams(params1);
    ...
    private void addFooterView() {
        // footer view
        mFooterView = mInflater.inflate(R.layout.util_refresh_footer, this, false);
        ...
        params.topMargin = mHeaderView.getPaddingBottom();
...
//				 setHeaderPadding(-mHeaderViewHeight);
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderImageView.setImageResource(R.drawable.mpush_g_pulltorefresh_arrow);
        mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
    ...
    public void onFooterRefreshComplete() {
        ...
        mFooterImageView.setImageResource(R.drawable.mpush_g_pulltorefresh_arrow_up);
        mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
