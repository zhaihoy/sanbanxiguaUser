package com.hbbc.mshare.user.reservation;
...
import com.hbbc.mshare.user.OrderPaymentActivity;
...
//        getHeapInfo();
    ...
    protected void initView() {
        ...
        TextView tv_amount= (TextView) findViewById(R.id.tv_amount);//底部金额为物品定金
