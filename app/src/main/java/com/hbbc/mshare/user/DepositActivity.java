...
public class DepositActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener, MyTopbar.OnTopBarClickListener {
    ...
    private void registerLocalReceiver() {
        ...
        Log.d(TAG, "registerLocalReceiver: +++++++-=="+intentFilter);
    ...
    protected void initView() {
        ...
        //显示需要支付的押金金额
        float deposit2Pay = UserDao.getDaoInstance(this).queryCurrentProcessingUser().getPayDespositNum();
...
//                    Toast.makeText(DepositActivity.this, "调用支付定金接口", Toast.LENGTH_SHORT).show();
    ...
    private void submit() {
        ...
        String[] params = {
                ...
                ,Constants.DespositCount,String.valueOf(deposit2Pay),Constants.OpenID,""};
...
//                Toast.makeText(this, "正常调起支付", Toast.LENGTH_SHORT).show();
                ...
                if (api == null) {
                    System.out.println(GlobalConfig.WEIXIN_USER_APP_ID);
