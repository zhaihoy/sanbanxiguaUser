...
public class CustomerServiceActivity extends BaseActivity implements MyTopbar.OnTopBarClickListener {
    ...
    private void submitSuggestion() {
        ...
        String[] params = new String[]{Constants.ECID, GlobalConfig.ECID,Constants.PhoneNumber,phoneNumber,
            Constants.CSFeedback,suggestion,Constants.AppType,GlobalConfig.AppType};
        httpUtil.callJson(handler,this,GlobalConfig.SHARER_SERVER_ROOT+GlobalConfig.SHARER_CUSTOMER_SERVICE,
