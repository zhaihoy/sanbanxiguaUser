 ...
 */
public class
WithDrawActivitys extends BaseActivity implements MyTopbar.OnTopBarClickListener {

    private static final int FLAG_AMOUNT = 0;

    private static final int FLAG_ACCOUNT = 1;

    private static final String TAG = "WalletActivitys";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mshare_withdraws);
    ...
    protected void initView() {
        ...
        openDesposit = currentUser.getOpenDesposit();
        Log.d(TAG, "initView: _+_+_+_+_+_+_+"+ openDesposit);
        ...
        tvTixianMoney.setText(String.valueOf(openDesposit));
        ...
        TextView tvs_amounts = (TextView) findViewById(R.id.stvss_amounts);
        tvs_amounts.setText(String.valueOf(openDesposit));
        ...
        withdraw_type = intent.getIntExtra("withdraw_type", 2);
        topbar.setTitle(withdraw_type == 1 ? "申请提现" : "退还押金");

        TextView tv_tip01 = (TextView) findViewById(R.id.tv_tip);
        TextView tv_tip02 = (TextView) findViewById(R.id.tv_tip1);
        tv_tip01.setText("当前押金");
        tv_tip02.setText("押金退还");

        TextView tv_withdraw_type = (TextView) findViewById(R.id.tv_withdraw_type);
        tv_withdraw_type.setText((withdraw_type == 2) ? "提现金额" : "退还押金");
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!TextUtils.isEmpty(input)) {
                    ((TextView) findViewById( R.id.tv_account)).setText(input);
                }
