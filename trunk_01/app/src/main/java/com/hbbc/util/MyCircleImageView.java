...
/**
 * 自定义圆的ImageView
 *          eg:<com.hbbc.util.MyCircleImageView>
 *                  apps:border_width="2dp"             圆的边框宽度
 *                  apps:border_color="@color/white"    边框的颜色
...
public class MyCircleImageView extends ImageView {
    ...
    /**
     *将Drawable资源转换为Bitmap，其调用的还是getBitmapFromDrawable
     */
    @Override
    ...
    /**
     *通过resId得到Drawable资源，之后调用getBitmapFromDrawable转换为Bitmap
     */
    @Override
