...
//            GlobalConfig.AutoLoginKey="";
        ...
        httpUtil.callJson(handler, SUBMIT_INFO_TO_SERVER, this, GlobalConfig.MSHARE_SERVER_ROOT + GlobalConfig.MSHARE_LOGIN,
    ...
    private void getVerificationCode() {
        ...
        httpUtil.callJson(handler, GET_VERIFICATION_CODE, this,
                GlobalConfig.MSHARE_SERVER_ROOT + GlobalConfig.MSHARE_GET_VERIFICATION_CODE, BaseResultBean.class, params);
    }
