...
public class OptionItem extends MyLinearLayout {
     ...
     */
    public OptionItem setRadioButtonDimension(int dimension) {

        rb_width = (int) (getResources().getDisplayMetrics().density * dimension);
         LinearLayout.LayoutParams params = (LayoutParams) rb.getLayoutParams();
        params.width=rb_width;
        params.height=rb_width;
     ...
     */
    public OptionItem setRadioButtonMarginLeft(int marginLeft) {
     ...
     * 设置RadioButton的显示状态
     */
    public OptionItem setRadioButtonStatus(boolean status){
        rb.setVisibility(status?VISIBLE:GONE);
        return this;
    }
