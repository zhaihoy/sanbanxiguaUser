...
//                    Toast.makeText(DepositActivity.this, "调用支付定金接口", Toast.LENGTH_SHORT).show();
    ...
    private void submit() {
        ...
        httpUtil.callJson(handler, RETRIEVE_SIGNED_ORDER, this, GlobalConfig.MSHARE_SERVER_ROOT + GlobalConfig.MSHARE_PAY_DEPOSIT, SignedOrderBean.class, params);
...
//        startActivity(new Intent(this, MainActivity.class));
    ...
    private void handleZFBPayResult(Message msg) {
        ...
        String[] params = {Constants.ECID,GlobalConfig.ECID,Constants.PhoneNumber,phoneNumber,Constants.PayOrderID,orderBean.getPayOrderID()};
        Log.d(TAG, "handleZFBPayResult: ecid=="+GlobalConfig.ECID+"phone=="+phoneNumber+"payorderId=="+orderBean.getPayOrderID());
...
//                Toast.makeText(this, "正常调起支付", Toast.LENGTH_SHORT).show();
    ...
    public class WXPayResultReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //开启服务去服务器查询真实的支付结果,根据payOrderId
