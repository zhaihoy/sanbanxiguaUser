...
public class MyItemTouchHandler extends ItemTouchHelper.Callback {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState == ItemTouchHelper.ACTION_STATE_DRAG) {
            // 拖拽状态
            ObjectAnimator.ofFloat(viewHolder.itemView,View.SCALE_X,1.1f).setDuration(100).start();
            ObjectAnimator.ofFloat(viewHolder.itemView,View.SCALE_Y,1.1f).setDuration(100).start();
...
//        viewHolder.itemView.setScaleY(1.0f);
        ...
        ObjectAnimator.ofFloat(viewHolder.itemView, View.SCALE_X,1f).setDuration(100).start();
        ObjectAnimator.ofFloat(viewHolder.itemView,View.SCALE_Y,1f).setDuration(100).start();
