 ...
 * @author Ryan.Tang
 */
public class ScanActivity extends Activity implements Callback, OnClickListener, MyTopbar.OnTopBarClickListener {
...
//        finish();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {//打开手动输入界面,并关闭当前扫码界面
            case R.id.tv_input:
                startActivity(new Intent(this,ScanInputActivity.class));
                finish();
