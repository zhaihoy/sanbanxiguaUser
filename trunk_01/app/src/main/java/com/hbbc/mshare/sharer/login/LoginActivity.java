...
//            ToastUtil.toast("操作异常,请重新登陆"+"保存失败");
    ...
    private void registerAppIdToWeChat() {
        api = WXAPIFactory.createWXAPI(this,GlobalConfig.WEIXIN_APP_ID,false);
...
//            GlobalConfig.AutoLoginKey="";
        ...
        String[] params = new String[]{Constants.ECID, GlobalConfig.ECID,
                ...
                Constants.AutoLoginKey, resultBean==null?"":resultBean.getAutoLoginKey(),
                Constants.AppType, GlobalConfig.AppType};
        httpUtil.callJson(handler, SUBMIT_INFO_TO_SERVER, this, GlobalConfig.SHARER_SERVER_ROOT + GlobalConfig.SHARER_LOGIN_IN,
    ...
    private void getVerificationCode() {
        ...
        String[] params = new String[]{"ECID", GlobalConfig.ECID + "", "PhoneNumber", phone_number, "AppType", GlobalConfig.AppType};
        //发起获取验证码请求
        httpUtil.callJson(handler, GET_VERIFICATION_CODE, this,
                GlobalConfig.SHARER_SERVER_ROOT + GlobalConfig.SHARER_RETRIEVE_VERIFICATION_CODE, BaseResultBean.class, params);
    }
